...
$sqlregister = " INSERT INTO 'tbl_users'( 'user_email', 'user_name', 'user_phone', 'user_password' ) VALUES ('$name','$email' , '$hashedpassword', '$phone');";
...
try {
    ...
    $response = array("status" => "error", "message" => $ex->getMessage(), $ex->getTraceAsString());
